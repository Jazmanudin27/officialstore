...
export default function ProfileScreen({ user, onOpenAuth, onLogout, onOpenAddress }) {
    ...
    <ScrollView style={styles.container} contentContainerStyle={styles.scrollContent}>
      ...
      <View style={styles.menuContainer}>
        <TouchableOpacity
          ...
          onPress={() => Alert.alert('Riwayat Pesanan', 'Semua riwayat transaksi belanja Anda tercatat aman.')}
          activeOpacity={0.7}
        >
